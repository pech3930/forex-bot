...
def build_agents(pairs,signals):
    ...
    desk_positions=[
        (0.30, 0.50),  # เก้าอี้ 1: ซ้ายบน หน้าโต๊ะติดหน้าต่าง
        (0.40, 0.60),  # เก้าอี้ 2: กลางซ้าย ระหว่างโต๊ะคู่
        (0.47, 0.68),  # เก้าอี้ 3: กลางล่าง หน้าโต๊ะล่าง
        (0.56, 0.60),  # เก้าอี้ 4: กลางขวา ระหว่างโต๊ะคู่
        (0.63, 0.50),  # เก้าอี้ 5: ขวาบน หน้าโต๊ะขวา
        (0.76, 0.62),  # เก้าอี้ 6: ขวาล่าง หน้า whiteboard
    ]
    agents=[]
