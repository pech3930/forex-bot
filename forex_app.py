...
def render_news_panel(overview, signals, watch):
    ...
    for p,(sig,reason) in signals.items():
        ...
        signal_rows+=f'<div style="background:#1a1a2e;border-left:3px solid {sc};padding:6px 8px;margin:6px 0"><div style="display:flex;justify-content:space-between;align-items:center"><span style="font-family:\'Press Start 2P\',monospace;font-size:7px;color:#fff">{p}</span><span style="font-family:\'Press Start 2P\',monospace;font-size:16px;color:{sc};border:1px solid {sc};padding:2px 5px">{arrow} {sig}</span></div><div style="font-family:\'Press Start 2P\',monospace;font-size:10px;color:#aaa;line-height:1.9;margin-top:5px">{reason}</div></div>'
